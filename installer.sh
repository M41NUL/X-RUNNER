...
R="\033[91m"; G="\033[92m"; Y="\033[93m"; M="\033[95m"; C="\033[96m"
O="\033[38;5;208m"; PK="\033[38;5;213m"; W="\033[97m"
B="\033[1m"; DIM="\033[2m"; RST="\033[0m"

clear

# Per-letter colors: X=R, -=W(spaces+▬), R=Y, U=G, N=C, N=M, E=PK, R=O
echo -e " ${R}${B}██╗  ██╗${RST}  ${W}${B}     ${RST}  ${Y}${B}██████╗ ${RST}  ${G}${B}██╗   ██╗${RST}  ${C}${B}███╗   ██╗${RST}  ${M}${B}███╗   ██╗${RST}  ${PK}${B}███████╗${RST}  ${O}${B}██████╗ ${RST}"
echo -e " ${R}${B}╚██╗██╔╝${RST}  ${W}${B}     ${RST}  ${Y}${B}██╔══██╗${RST}  ${G}${B}██║   ██║${RST}  ${C}${B}████╗  ██║${RST}  ${M}${B}████╗  ██║${RST}  ${PK}${B}██╔════╝${RST}  ${O}${B}██╔══██╗${RST}"
echo -e "  ${R}${B}╚███╔╝${RST}  ${W}${B}▬▬▬▬▬${RST}  ${Y}${B}██████╔╝${RST}  ${G}${B}██║   ██║${RST}  ${C}${B}██╔██╗ ██║${RST}  ${M}${B}██╔██╗ ██║${RST}  ${PK}${B}█████╗  ${RST}  ${O}${B}██████╔╝${RST}"
echo -e "  ${R}${B}██╔██╗${RST}  ${W}${B}▬▬▬▬▬${RST}  ${Y}${B}██╔══██╗${RST}  ${G}${B}██║   ██║${RST}  ${C}${B}██║╚██╗██║${RST}  ${M}${B}██║╚██╗██║${RST}  ${PK}${B}██╔══╝  ${RST}  ${O}${B}██╔══██╗${RST}"
echo -e " ${R}${B}██╔╝ ██╗${RST}  ${W}${B}     ${RST}  ${Y}${B}██║  ██║${RST}  ${G}${B}╚██████╔╝${RST}  ${C}${B}██║ ╚████║${RST}  ${M}${B}██║ ╚████║${RST}  ${PK}${B}███████╗${RST}  ${O}${B}██║  ██║${RST}"
